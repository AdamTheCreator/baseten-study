...
- **Weak areas to revisit:** TTFT vs TPOT mapping; KV cache spans BOTH phases (mostly resolved); reach for fast levers (quant/bigger GPU) before slow ones (distillation); decimal vs binary MB/MiB conventions (minor)
